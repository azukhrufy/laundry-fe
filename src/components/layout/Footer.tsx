...
/**
 * Represents a social media button with an icon that serves as a link to a given URL.
 *
 * @param {object} props - The properties for the SocialButton component.
 * @param {ReactNode} props.children - The content of the SocialButton, usually an icon.
 * @param {string} props.label - The label for the SocialButton, used for accessibility.
 * @param {string} props.href - The URL to which the SocialButton will navigate when clicked.
 *
 * @returns {JSX.Element} The rendered JSX element representing the SocialButton.
 */
const SocialButton = ({
  children,
  label,
...
/**
 * Represents the header of a list section.
 *
 * @param {object} props - The properties for the ListHeader component.
 * @param {ReactNode} props.children - The content of the ListHeader, usually text.
 *
 * @returns {JSX.Element} The rendered JSX element representing the ListHeader.
 */
...
/**
 * Represents a component displaying various sections in a large layout with a newsletter subscription form.
 *
 * @returns {JSX.Element} The rendered JSX element representing the LargeWithNewsletter component.
 */
    ...
    >
      <Container as={Stack} maxW={"6xl"} py={10}>
        <SimpleGrid
          ...
          spacing={8}
        >
          {/* Section: Logo and Company Information */}
          <Stack spacing={6}>
            <Box>
              <div className="flex flex-col gap-0 justify-center ">
                <h3 className="t text-xl font-bold leading-3 text-gray-600">
                  iLaundry
                </h3>
                <p className="t text-sm text-gray-600">powered by FTS</p>
              </div>
            </Box>
            <Text fontSize={"sm"}>© 2023 Future Technology Solution</Text>
